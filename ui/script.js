...
// API Setup - Changed to your Flask backend endpoint
const API_URL = "http://localhost:5000/chat"; // Default Flask port
...
const generateResponse = async (botMsgDiv) => {
  ...
  try {
    // Send the user's question to your Flask backend
