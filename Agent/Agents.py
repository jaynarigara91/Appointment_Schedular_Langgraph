from Agent.tools import CREATE_CALENDAR_EVENT,SEARCH_CALENDAR_EVENT,DELETE_CALENDAR_EVENT,UPDATE_CALENDAR_EVENT
...
class Appointment:
    ...
    def chat_bot(self,state: MessagesState):
    ...
    def tools_condition(self,state: MessagesState) -> Literal["find_slots",  "tool", "__end__"]:
        """
    ...
    def find_slots(self,state: MessagesState) -> Literal["Chatbot"]:
        """
        Determine if the conversation should continue to tools or end
        """
        messages = state["messages"]
